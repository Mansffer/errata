        ...
        content: (
          <>
            ...
            <P>
              ...
              If Errata is running on a local port other than <Mono>3000</Mono>, OpenRouter redirects
              to a localhost callback URL that you can paste back into the provider panel to finish.
            </P>
          </>
        ),
      },
